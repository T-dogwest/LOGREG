...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public boolean addToTable(String email, String username, String password, String fullname) {
        if (!canBeAdded(email, username, fullname)) {
            return false;
        }
    ...
    public boolean canBeAdded(String email, String username, String fullname) {
        if (!isEmail(email) || !isFullname(fullname)) {
            return false;
        }
        else if (checkEmailIfExist(email) || checkUsernameIfExist(username)) {
            return false;
        }
        else {
            return true;
